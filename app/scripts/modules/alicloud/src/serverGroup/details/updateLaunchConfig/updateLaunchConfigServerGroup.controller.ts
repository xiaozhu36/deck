    ...
    function($scope: any, $uibModalInstance: any, serverGroupWriters: any, application: any, serverGroup: any) {
      ...
      this.submit = function() {
        if ($scope.serverGroup.result.scalingConfiguration.spotStrategy !== 'SpotWithPriceLimit') {
          ...
          $scope.serverGroup.result.scalingConfiguration.spotPriceLimit[0].instanceType =
            $scope.serverGroup.result.scalingConfiguration.instanceType;
          $scope.serverGroup.result.scalingConfiguration.spotPriceLimit[0].priceLimit = parseFloat(
            $scope.serverGroup.result.scalingConfiguration.spotPriceLimit[0].priceLimit,
          );
        }
